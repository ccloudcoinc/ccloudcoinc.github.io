[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-f059dc9a6f8d3a56e377f745f24479a46679e63a5d9fe6f495e02850cd0d8118.svg)](https://classroom.github.com/online_ide?assignment_repo_id=5416445&assignment_repo_type=AssignmentRepo)
# :wave: My Profile
...
## (Week 2) :octocat: Add CSS to beautify my profile

* Added a smilinng face photo of myself
* Added a Youtube video about Japan
* Written a small biograpghy and put in in a box
* Added a css folder with a style.css file for my css code
* Added favicon for website icon
* HTML code reference from Krazywoman repo session 2 challenge 1 html

## (Week 3-4) :octocat: Add Bootstrap to beautify my profile

* Added bootstrap to index.html and edit class'box' to class'container'
* Edit index.html with new navigation bar and style.css
* Added project.html,pstyle.css and test.html( for code testing)
* Link index.html to project.html
* Added cards,navigation bar, carosel, button, form and modal to project.html

## (Week 5) :octocat: Add JavaScript to your website

* Added js folder,animate.html
* Rename project.html to profile.html  
* Use Javascript for message confirmation and modal closing for profile.html
* Add animate.js which is a CodePen by Matei Copot named Pacman
